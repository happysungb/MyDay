...
class ListTwoLunch: RecyclerView.Adapter<ListTwoLunch.ListTwoLunchHolder>() {
    var selectedList = mutableListOf<Selected>()
    inner class ListTwoLunchHolder(private val binding: SelectedListTwoBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListTwoLunchHolder {
        val binding = SelectedListTwoBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return ListTwoLunchHolder(binding)
    }
    ...
    override fun onBindViewHolder(holder: ListTwoLunchHolder, position: Int) {
